 ...
 *    6) List projects initially assigned to any resource
 *    7) List all roles assigned to a project
 *    X) Exit.</pre>
 * 
 ...
 * Modification Log
 * ***************************************************************************
 * v1.7, S. Lago,       2013-Jan-15 - Modification 2
 * 
 * v1.6, A. Marc-Andr�, 2013-Jan-15 - Modification 1
 * 
...
public class Menus {
	...
	public char mainMenu() {
		...
		while (error) {
			...
			System.out.println("6) List projects initially assigned to any resource");  //NEW
			System.out.println("7) List all roles assigned to a project");  //NEW
