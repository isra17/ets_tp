...
public class Executive extends Communication {
	...
	public void execute() {
		...
		addToReceiverList("ListProjectRoleComponent");
		...
		addToReceiverList("ListProjectsInitialyAssignedToResourceComponent");
		...
		while (!done) {
			...
			case '5':
				signalReceivers("ListProjectsInitialyAssignedToResourceComponent");
				break;
				
			case '6':
				signalReceivers("ListProjectRoleComponent");
				break;
