 ...
 * {@link ca.etsmtl.log430.common.dao.ResourceReader ResourceReader} class header.
 * The project objects are initialized from another file (<tt>projects.txt</tt>).
 * The format of this file is listed in the
 * {@link ca.etsmtl.log430.common.dao.ProjectReader ProjectReader} class header.<br><br>
 * 
