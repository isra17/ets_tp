...
import ca.etsmtl.log430.common.dao.ProjectReader;
import ca.etsmtl.log430.common.dao.ResourceReader;
import ca.etsmtl.log430.lab2.component.Communication;
...
/*
 * Modification Log **********************************************************
 * v1.5, I. Hallé, 5-Fev-14 - Add modifications for labl #2
 * 
...
public class CommonData {
	...
	public CommonData() {
		if (!initialized) {
			...
			theListOfResources = new ResourceReader(defaultResourceFile, theListOfProjects.getListOfProjects());
