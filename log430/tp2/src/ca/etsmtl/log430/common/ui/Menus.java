package ca.etsmtl.log430.common.ui;
 ...
 * Modification Log
 * ***************************************************************************
 * v1.6, I. Hallé, 5-Fev-14 - Implements additionnal functionnality for labo #2
 * 
...
public class Menus {
	...
	public char mainMenu() {
		...
		while (error) {
			...
			System.out.println("5) List projects initially assigned to a resource");
			System.out.println("6) List project assigned role");
			System.out.println("7) Assign a resource to a project");
