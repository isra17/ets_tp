package ca.etsmtl.log430.common.dao;
 ...
 * Modification Log
 ************************************************************************
 * v1.8, I. Hallé, 5-Fev-14 - Link resource to projects
 * 
...
public class ResourceReader extends LineOfTextFileReader {
	...
	private ProjectList listOfProjects; //Nécessaire pour remplir la liste de projets assignés précédemment.
