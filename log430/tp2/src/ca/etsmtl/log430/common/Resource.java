...
public class Resource {
	...
	/**
	 * Check if a ressource can be assigned to a new project.
	 * 
	 * @return false if a ressource would be overloaded with this project. 
	 * true otherwise.
	 */
	...
	/**
	 * Return a list of all the assigned projects of a resource (Both from 
	 * this session and previous session)
	 */
	public ProjectList getAllAssignedProjects() {
		ProjectList allProject = new ProjectList();
		Project current = null;
		projectsAssignedList.goToFrontOfList();
		while((current = projectsAssignedList.getNextProject()) != null) {
			allProject.addProject(current);
		}
