		...
		if (argv.length != 2) {
			...
			while (!done) {
				...
				case '6':
					...
					resource = menu.pickResource(resourceList.getListOfResources());
					if (resource != null) {
						display.displayProjectsInitiallyAssignedToResource(resource);
					} // if
					
					//display.displayProjectsInitiallyAssignedToResource(resourceList.getListOfResources());
				...
				case '7':
					...
					//display.displayRoleList(resourceList.getListOfResources());
